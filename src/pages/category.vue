    ...
    <div id="category">
        <el-card>
            <el-menu :default-active="activeIndex" class="el-menu-demo" mode="horizontal">
                <el-menu-item index="1">秒杀</el-menu-item>
                <el-menu-item index="2">优惠券</el-menu-item>
                <el-menu-item index="3">PLUS会员</el-menu-item>
                <el-menu-item index="4">品牌闪购</el-menu-item>
                <el-menu-item index="5">拍卖</el-menu-item>
                <el-menu-item index="6">京东家电</el-menu-item>
                <el-menu-item index="7">京东超市</el-menu-item>
                <el-menu-item index="8">京东生鲜</el-menu-item>
                <el-menu-item index="9">京东国际</el-menu-item>
                <el-menu-item index="10">京东云</el-menu-item>
            </el-menu>
        ...
        <el-row>
            <el-card>
                <el-row>
                    <el-col :span="3">
                        <el-image src="https://img10.360buyimg.com/babel/s320x320_jfs/t1/157883/11/8211/66180/6033a3a6Ebc57b12f/03412a53cb7c5ae8.jpg!cc_320x320.webp"></el-image>
                        <span class="info">华为HUAWEI Mate X2 无缝鹰翼折叠</span>
                        <span class="price">￥17799.00</span>
                    </el-col>
                    <el-col :span="1"><div class="none"></div></el-col>
                    <el-col :span="3">
                        <el-image src="https://img30.360buyimg.com/babel/s320x320_jfs/t1/178933/38/9600/133188/60cc5ce4E6ceb1db2/bd8360ba2964f9bf.jpg!cc_320x320.webp"></el-image>
                        <span class="info">荣耀50 Pro 1亿像素超清影像 5G </span>
                        <span class="price">￥3399.00</span>
                    </el-col>
                    <el-col :span="1"><div class="none"></div></el-col>
                    <el-col :span="3">
                        <el-image src="https://img13.360buyimg.com/babel/s320x320_jfs/t1/156049/15/16968/101724/6054a710Efe177733/52de2b412819280b.jpg!cc_320x320.webp"></el-image>
                        <span class="info">vivo S9e 5G手机 星夜极光 </span>
                ...
                categoryList:[
                    {
                        name:'品牌',
                        tagList:
                            ['OPPO','小米(MI)','荣耀','魅族','Apple','黑鲨','华为','一加','三星','真我','摩托罗拉','联想','中兴','努比亚','ROG'],
                        checked:undefined
                    },
                    {
                        name:'功能',
                    ...
                    {
                        name:'系统',
                        tagList:['IOS','Android','HarmoryOS2','EMUI 11.0','其他OS'],
                        checked:undefined
                    },
                    {
                        name:'CPU',
                        tagList:['骁龙 768G','骁龙855plus','MT6873','麒麟990','麒麟990 5G','Exynos980','MTK Hello G85','紫光展锐','骁龙865plus','天玑1000plus'],
                        checked:undefined
                    }
                ]
            }
